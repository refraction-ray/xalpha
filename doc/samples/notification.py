...
st2 = xa.policy.scheduled(cm, totmoney = 1000, times=pd.date_range('2018-01-01','2019-01-01',freq='W-MON'))
st3 = xa.policy.scheduled(gf, totmoney = 500, times=pd.date_range('2018-01-01','2019-01-01',freq='W-WED'))
st4 = xa.policy.scheduled_tune(cm, totmoney = 1000, times=pd.date_range('2018-01-01','2019-01-01',freq='W-TUE'), piece=[(0.95,2),(1,1)])
...
conf = {'sender': 'aaa@bb.com', 'sender_name':'name',
	'receiver':['aaa@bb.com','ccc@dd.com'], 'password':'123456',
